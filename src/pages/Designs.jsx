        ...
        <div className={styles.designsContainer}>
          ...
          >
            <div className={styles.card}>
              <img className={styles.image} src={dragonBallApp} alt="" />
          ...
          >
            <div className={styles.card}>
              <img className={styles.image} src={foodF} alt="" />
          ...
          >
            <div className={styles.card}>
              <img className={styles.image} src={gpsF} alt="" />
          ...
          >
            <div className={styles.card}>
              <img className={styles.image} src={neumorphismF} alt="" />
          ...
          >
            <div className={styles.card}>
              <img className={styles.image} src={petsearchF} alt="" />
          ...
          >
            <div className={styles.card}>
              <img className={styles.image} src={pomodoroF} alt="" />
